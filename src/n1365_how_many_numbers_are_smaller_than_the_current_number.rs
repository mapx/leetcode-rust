 ...
 * Discuss link: https://leetcode.com/problems/how-many-numbers-are-smaller-than-the-current-number/discuss/?currentPage=1&orderBy=most_votes
 */
pub struct Solution {}
